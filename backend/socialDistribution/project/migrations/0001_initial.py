    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "followers_open_friend_requests",
                    models.ManyToManyField(
                        blank=True, related_name="open_requests", to="project.Author"
                    ),
                ),
                (
                    "following",
                    models.ManyToManyField(
                        blank=True, related_name="i_am_following", to="project.Author"
                    ),
                ),
                (
                    "friends",
                    models.ManyToManyField(
                        blank=True, related_name="my_friends", to="project.Author"
                    ),
                ),
                (
                    "user",
