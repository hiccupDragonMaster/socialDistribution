...
class SendFollowRequestTest(TestCase):
    ...
    def test_cannot_follow_self(self):
        ...
        self.client.post(reverse("project:follow", args=[author.id]))
    ...
    def test_inverse_follow_request(self):
        ...
        self.client.post(reverse("project:follow", args=[bob.id]))
        query = FollowRequest.objects.filter(follower=alice, following=bob)
...
class AcceptFollowRequestTest(TestCase):
    ...
    def test_follow_request_accepted(self):
        ...
        self.assertFalse(query.exists())
        self.assertEqual(alice.followers.first(), bob)
        self.assertEqual(bob.following.first(), alice)
    ...
    def test_true_friend(self):
        ...
        self.client.post(reverse("project:accept_follow", args=[self.fr.id]))
        self.assertEqual(alice.followers.first(), bob)
        self.assertEqual(bob.followers.first(), alice)
...
class DeclineFollowRequestTest(TestCase):
    ...
    def test_reverse_follow_maintained(self):
        ...
        self.client.post(reverse("project:decline_follow", args=[self.fr.id]))
        self.assertFalse(self.alice.followers.exists())
...
class UnfollowTest(TestCase):
    ...
    def test_reverse_follow_maintained(self):
        ...
        self.client.post(reverse("project:unfollow", args=[self.bob.id]))
